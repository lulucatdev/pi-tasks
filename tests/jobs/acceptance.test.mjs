...
import { evaluateAcceptance, matchesPathPattern } from "../../extensions/jobs/acceptance.ts";
...
test("evaluateAcceptance ignores supervisor protocol artifacts in write-boundary checks", async () => {
  ...
  const result = await evaluateAcceptance({
    ...
    observedWritePaths: [
      "src/telemetry.md",
      ".pi/jobs/2026-04-27T00-00-00-000Z-test/attempts/t001/attempt-1/worker.md",
      ".pi/jobs/2026-04-27T00-00-00-000Z-test/attempts/t001/attempt-1/job-report.json",
    ],
