...
import { buildAttemptRecord, runWorkerAttempt } from "../../extensions/jobs/worker-runner.ts";
...
test("buildAttemptRecord preserves runtime evidence and artifact paths", async () => {
  ...
  const record = buildAttemptRecord({ job: makeJob(), attemptId: "t001-a1", attemptIndex: 1, paths, runtime });
