...
import { retryDecisionForFailure } from "../../extensions/jobs/failure-classifier.ts";
import { buildWorkerEvent, detectWorkerStall } from "../../extensions/jobs/worker-events.ts";
...
test("detectWorkerStall classifies stale heartbeats as worker stalled", () => {
  const events = [buildWorkerEvent({ type: "heartbeat", jobId: "t001", attemptId: "t001-a1", at: "2026-04-26T00:00:00.000Z" })];
...
test("detectWorkerStall classifies stale in-flight tool calls as provider stalled", () => {
  const events = [buildWorkerEvent({ type: "tool_call_started", jobId: "t001", attemptId: "t001-a1", tool: "bash", at: "2026-04-26T00:00:00.000Z" })];
